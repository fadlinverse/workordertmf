...
public class PartyCreditProfile   {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, partyCreditProfile.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, href, creditAgencyName, creditAgencyType, ratingReference, ratingScore, validFor, baseType, schemaLocation, type);
  }
